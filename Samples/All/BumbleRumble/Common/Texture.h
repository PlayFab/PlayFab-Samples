...
namespace DX
{
    ...
    public:
        ...
        Texture(_In_ ID3D12Device* device, DirectX::ResourceUploadBatch& resourceUpload,
            D3D12_CPU_DESCRIPTOR_HANDLE srvDescriptor,
            _In_z_ const char* fileName, bool forceSRGB = false);

#elif defined(__d3d11_h__) || defined(__d3d11_x_h__)

        Texture(_In_ ID3D11Device* device, _In_z_ const char* fileName, bool forceSRGB = false);
