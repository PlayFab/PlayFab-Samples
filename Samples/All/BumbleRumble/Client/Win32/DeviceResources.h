...
namespace DX
{
    ...
    public:
        ...
        // Performance events
        void PIXBeginEvent(_In_z_ const char* name)
        {
            m_d3dAnnotation->BeginEvent(BumbleRumble::StrToWStr(name).c_str());
        }
        ...
        void PIXSetMarker(_In_z_ const char* name)
        {
            m_d3dAnnotation->SetMarker(BumbleRumble::StrToWStr(name).c_str());
        }
