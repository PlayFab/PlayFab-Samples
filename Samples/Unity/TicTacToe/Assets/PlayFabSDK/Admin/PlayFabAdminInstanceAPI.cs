...
namespace PlayFab
{
    ...
    public class PlayFabAdminInstanceAPI : IPlayFabInstanceApi
    {
        ...
        /// </summary>
        public void CreateCloudScriptAzureFunctionsTask(CreateCloudScriptAzureFunctionsTaskRequest request, Action<CreateTaskResult> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            var context = (request == null ? null : request.AuthenticationContext) ?? authenticationContext;
            var callSettings = apiSettings ?? PlayFabSettings.staticSettings;
            PlayFabHttp.MakeApiCall("/Admin/CreateCloudScriptAzureFunctionsTask", request, AuthType.DevSecretKey, resultCallback, errorCallback, customData, extraHeaders, context, callSettings, this);
        }
        ...
        /// </summary>
        public void GetCloudScriptAzureFunctionsTaskInstance(GetTaskInstanceRequest request, Action<GetCloudScriptAzureFunctionsTaskInstanceResult> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            var context = (request == null ? null : request.AuthenticationContext) ?? authenticationContext;
            var callSettings = apiSettings ?? PlayFabSettings.staticSettings;
            PlayFabHttp.MakeApiCall("/Admin/GetCloudScriptAzureFunctionsTaskInstance", request, AuthType.DevSecretKey, resultCallback, errorCallback, customData, extraHeaders, context, callSettings, this);
        }
