...
namespace PlayFab.AdminModels
{
    ...
    [Serializable]
    public class CloudScriptAzureFunctionsTaskParameter : PlayFabBaseModel
    {
        /// <summary>
    ...
    [Serializable]
    public class CloudScriptAzureFunctionsTaskSummary : PlayFabBaseModel
    {
        /// <summary>
        /// UTC timestamp when the task completed.
        /// </summary>
    ...
    public class CreateCloudScriptAzureFunctionsTaskRequest : PlayFabRequestCommon
    {
        ...
        /// </summary>
        public CloudScriptAzureFunctionsTaskParameter Parameter;
        /// <summary>
        /// Cron expression for the run schedule of the task. The expression should be in UTC.
        /// </summary>
        public string Schedule;
    ...
    [Serializable]
    public class ExecuteFunctionResult : PlayFabBaseModel
    {
        /// <summary>
    ...
    public class GetCloudScriptAzureFunctionsTaskInstanceResult : PlayFabResultCommon
    {
        ...
        /// </summary>
        public CloudScriptAzureFunctionsTaskSummary Summary;
    }
