...
namespace PlayFab
{
    ...
    public static class PlayFabAdminAPI
    {
        ...
        /// </summary>
        public static void CreateCloudScriptAzureFunctionsTask(CreateCloudScriptAzureFunctionsTaskRequest request, Action<CreateTaskResult> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            var context = (request == null ? null : request.AuthenticationContext) ?? PlayFabSettings.staticPlayer;


            PlayFabHttp.MakeApiCall("/Admin/CreateCloudScriptAzureFunctionsTask", request, AuthType.DevSecretKey, resultCallback, errorCallback, customData, extraHeaders, context);
        }
        ...
        /// </summary>
        public static void GetCloudScriptAzureFunctionsTaskInstance(GetTaskInstanceRequest request, Action<GetCloudScriptAzureFunctionsTaskInstanceResult> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            var context = (request == null ? null : request.AuthenticationContext) ?? PlayFabSettings.staticPlayer;


            PlayFabHttp.MakeApiCall("/Admin/GetCloudScriptAzureFunctionsTaskInstance", request, AuthType.DevSecretKey, resultCallback, errorCallback, customData, extraHeaders, context);
        }
