...
namespace PlayFab
{
    ...
    public class PlayFabProfilesInstanceAPI : IPlayFabInstanceApi
    {
        ...
        /// </summary>
        public void SetAvatarUrl(SetAvatarUrlRequest request, Action<SetAvatarUrlResponse> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            var context = (request == null ? null : request.AuthenticationContext) ?? authenticationContext;
            var callSettings = apiSettings ?? PlayFabSettings.staticSettings;
            PlayFabHttp.MakeApiCall("/Profile/SetAvatarUrl", request, AuthType.EntityToken, resultCallback, errorCallback, customData, extraHeaders, context, callSettings, this);
        }
